...
only use  head_cam high camera(demo_egodex)
"""
...
def create_empty_dataset(
    ...
    *,
    ...
    if use_wrist:
        cameras.extend(["cam_left_wrist", "cam_right_wrist"])

    features = {
        "observation.state": {
            "dtype": "float32",
            "shape": (len(state_dims), ),
            "names": [
                state_dims,
            ],
        },
    ...
    for cam in cameras:
        features[f"observation.images.{cam}"] = {
            "dtype": mode,
            "shape": (3, 480, 640), # 正常情况
            # "shape": (3, 180, 320),   # Egodex 摄像头
            "names": [
                "channels",
                "height",
                "width",
