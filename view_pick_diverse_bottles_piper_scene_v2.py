...
║  原点色块         名称前缀              含义                      ║
║──────────────────────────────────────────────────────────────────║
║  ■ 白色           bottle_center         瓶子几何中心              ║
║  ■ 亮黄色         place_target          放置目标位姿              ║
║  ■ 亮青色         ee_current            当前 夹爪尖端 (腕部+10cm) ║
║  ■ 浅蓝色         stage_pregrasp        预抓取阶段 目标           ║
║  ■ 浅绿色         stage_grasp_lower     下降抓取阶段 目标         ║
║  ■ 金黄色         stage_lift            抬升阶段 目标             ║
║  ■ 橙红色         stage_move_out        移出阶段 目标             ║
╠══════════════════════════════════════════════════════════════════╣
║  所有 EE / 阶段轴均为夹爪尖端位置（腕部 +10cm 前进偏移）         ║
