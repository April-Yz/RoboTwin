...
def main():
    parser = argparse.ArgumentParser(description="Print h5 file structure and shapes.")
...
"""
action/ (Group)
action/act_arm_L: (649, 6)
action/act_arm_R: (649, 6)
action/act_grip_L: (649, 1)
action/act_grip_R: (649, 1)
observations/ (Group)
observations/arm_L: (649, 7)
observations/arm_R: (649, 7)
observations/grip_L: (649, 1)
observations/grip_R: (649, 1)
observations/head_depth: (649, 480, 640)
observations/head_rgb: (649, 480, 640, 3)
observations/left_depth: (649, 480, 640)
observations/left_rgb: (649, 480, 640, 3)
observations/right_depth: (649, 480, 640)
observations/right_rgb: (649, 480, 640, 3)
observations/ts: (649,)
