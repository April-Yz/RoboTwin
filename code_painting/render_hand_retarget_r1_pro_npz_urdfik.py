#!/usr/bin/env python3
"""URDF-IK variant of hand retarget replay for R1 Pro.
...
class HandRetargetR1ProURDFIKRenderer(base.HandRetargetR1Renderer):
    def __init__(self, *args, **kwargs) -> None:
        ...
        print(f"[ik-mode] robot=r1_pro solver=urdfik urdf={self.ik_urdf_path}")
...
base.HandRetargetR1Renderer = HandRetargetR1ProURDFIKRenderer
