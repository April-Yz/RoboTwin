...
- In addition to inter-strategy agreement, `analyze_selection_strategy_agreement_v4.py` now directly compares AnyGrasp candidate Selection Poses with OursV2 hand-replay Selection Poses. Orientation/Fused same-frame means are about 97.17/97.11 mm; arm-specific results, signed world ΔXYZ, and Top cross-frame contamination are reported separately. Orientation currently contributes 91.75% of the Fused score on average.
