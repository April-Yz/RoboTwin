...
- Selection Strategy Audit V4：只读比较 OursV2、Orientation、Fused 与真实 Top-score 候选；Selection/Planner 双面板会把不同 resolved frame 的 Foundation 画面分栏拼接。旧算法和结果不变，详见 `SELECTION_STRATEGY_AUDIT_V4.zh.md`。
