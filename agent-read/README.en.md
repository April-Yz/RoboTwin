...
- Cameras: head, front, side, right-side `third_camera`, opposite overhead `opposite_top_camera`, and top-level `third_view`. Foundation configs export distinct 0515 left/right wrist views through a Pika simulation stand-clearance adapter and support a live dual-wrist viewer mosaic.
